...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 00-29) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
(require 2htdp/image)

; EX 29
; group-photo: listOfPeople -> image
; GIVEN: a list of people as defined in EX 21
; RETURNS: an image of these people beside each other in a group photo

(define (group-photo lst)
(cond
  ; if list is empty do nothing
  [(empty? lst) (text "" 12 "green")]
  ; align the first person in the list beside to the rest of the people in the list
  [else (beside/align "bottom"
                (person-image (first lst)) (group-photo (rest lst)))]
))
...
; Test:
(group-photo (list (make-person "Yun" "Cheng" 25 64 145) 
                   (make-person "Dobby" "the House Elf" 36 25 55) 
                   (make-person "Albus" "Dumbledore" 75 85 175)))